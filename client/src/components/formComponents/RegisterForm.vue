<template>
  <form @submit.prevent="submitRegister">
      ...
      <div class="form-controls">
          <input type="email" placeholder="Enter email here" id="email" class="input-email" v-model="email">
      ...
      <div class="form-controls-check">
           ...
           <label for="security-check">GDPR Ok!</label>
      </div>
...
export default {
    ...
    methods:{
        submitRegister(){
            if(this.userName == null || this.userName == "" || this.password == null || this.password == "" || this.email == null || this.email == ""){
                 return;
            } else {
